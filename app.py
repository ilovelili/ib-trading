...
from IBJts.source.pythonclient.ibapi.client import Contract, Order, ScannerSubscription
from IBJts.source.pythonclient.ibapi.tag_value import TagValue
...
class PTLClient(EWrapper, EClient):
    ...
    def scannerData(
        self, req_id, rank, details, distance, benchmark, projection, legsStr
    ):
        super().scannerData(
            req_id, rank, details, distance, benchmark, projection, legsStr
        )
